          ...
          <div class="banner-right">
            <div class="banner-content">
              ...
              <div class="banner-desc">
                思MindSpore，自行研发基于知识图谱和大模型的国潮AIGC生态系统（AI生成2D平面图像、3D模型、视频等元宇宙数字内容），为元宇宙空间提供可商用的优质数字内容，优化工业设计到生产的流程效率，降本增效，有效的将文化遗产演变为数字资产，打通“文化-科技-消费”全链路径，释放国潮文化的源头生产力，在消费端打造一个率先出海的…
              </div>
            </div>
