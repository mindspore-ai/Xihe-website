    ...
    <div class="taichu-info-instance">
      ...
      <div class="taichu-info-instance-desc">
        ...
        <ul class="taichu-instance-challenges">
          <li class="taichu-instance-challenges-item">
            ...
            <div class="challenges-item-right">
              <div class="challenges-item-right-top">
                <span class="challenges-item-right-top-strip"></span>
                <div class="challenges-item-right-top-total">
                  <p class="title1">69000个词语</p>
                  <p class="title2">《现代汉语词典》新事物 新技术…</p>
                </div>
              </div>
              <div class="challenges-item-right-bottom">
                <span class="challenges-item-right-bottom-strip"></span>
                <span class="challenges-item-right-bottom-title3"
                  >8200个词语</span
                >
              </div>
            </div>
          ...
          <li class="taichu-instance-challenges-item">
            ...
            <div class="challenges-item-right">
              <div class="challenges-item-right-top">
                <span class="challenges-item-right-top-strip strip"></span>
                <div class="challenges-item-right-top-total">
                  <p class="title1">约460万聋哑学生</p>
                  <!-- <p class="title2">《现代汉语词典》新事物 新技术…</p> -->
                </div>
              </div>
              <div class="challenges-item-right-bottom bottom">
                <span class="challenges-item-right-bottom-strip strip"></span>
                <span class="challenges-item-right-bottom-title3">
                  约1万名手语教师</span
                >
              </div>
          ...
          <li class="taichu-instance-challenges-item">
            ...
            <div class="challenges-item-right">
              <ul class="challenges-item-right-arr">
                <li class="challenges-item-right-arr-li">
